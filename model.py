...
class DecoderBlock(nn.Module):
    ...
    def __init__(self, features: int, self_attention_block: MultiHeadAttentionBlock,
        ...
        # self.cross_attention_block = cross_attention_block  # khong nhìn lại vì bỏ r
...
def build_gpt_model(vocab_size: int, seq_len: int, d_model: int = 128,
                      N: int = 6, h: int = 8, dropout: float = 0.1, d_ff: int = 512):
    ...
    model = GPTModel(decoder,  tgt_embed,tgt_pos, projection_layer)
